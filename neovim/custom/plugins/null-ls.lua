...
local sources = {
    ...
    --
    -- others
    b.formatting.prettierd.with({filetypes = {"html", "markdown", "css", "yaml", "json", "javascript"}}), -- go
    b.formatting.goimports,
    b.formatting.gofmt,
    b.diagnostics.golangci_lint.with({diagnostics_format = "(#{s}) #{m}"}), -- english text
    b.diagnostics.proselint.with({diagnostics_format = "(#{s}) #{m}"}), -- TOOD not sure how to use it ?
    -- b.completion.spell,
    -- c/c++
